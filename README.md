...
In model 1, modifications are made to tain the sentiment classifier of Amazon reviews from the CL1 coursework with pytorch implementations including model specification, batch generation, the backwards step, loss function and optimisation. 
